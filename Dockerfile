...
LABEL "org.opencontainers.image.source"="https://github.com/step-security/action-slack-notify"

WORKDIR ${GOPATH}/src/github.com/step-security/action-slack-notify
COPY main.go ${GOPATH}/src/github.com/step-security/action-slack-notify
